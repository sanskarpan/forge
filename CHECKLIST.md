...
- The AArch64 scalar live-range reuse boundary is implemented on branch
  `codex/aarch64-live-range-20260907` for issue #366: eligible straight-line
  no-call programs now use inclusive liveness intervals to reuse dead D/X
  temporaries, while genuine pressure, calls, stack-backed parameters, and
  structured CFGs retain their established spill/ABI fallbacks. The focused
  AArch64 suite covers a 100-term reuse chain, callee-saved frame use, and
  simultaneous-live spill cases.
