...
and Issue #448 extends it with constant element offsets. The evaluator uses
...
dynamic pointer arithmetic or nested source loops; repeated uses of one column
must use one offset. Unsupported packed operations still use the verified
scalar element fallback.
